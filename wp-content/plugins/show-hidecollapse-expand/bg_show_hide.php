...
function bg_show_hide_shortcode($attr, $content = null) {
	...
	if ( $a["view"] == 'link' || $a["view"] == 'faq-link' ) {
		$showmore_btn = "<a id='bg-showmore-action-$bg_uniq_id' class='bg-showmore-plg-link $bg_btn_icon_class' $bg_onclick style=\" color:" . $bg_text_color . ';' . $bg_inline_css . ";\" href='#'>" . $bg_expand_text . "</a>";
	...
	elseif ( $a["view"] == 'button-orange') {
		$showmore_btn = "<button id='bg-showmore-action-$bg_uniq_id' class='bg-showmore-plg-button bg-orange-button' $bg_onclick " . $bg_btn_icon_class . " style=\" color:" . $bg_text_color . ";". $bg_inline_css ."\">" . $bg_expand_text . "</button>";	
		$bg_button_or_link = true;
	}	
	elseif ( $a["view"] == 'button-blue') {
		$showmore_btn = "<button id='bg-showmore-action-$bg_uniq_id' class='bg-showmore-plg-button bg-blue-button' $bg_onclick " . $bg_btn_icon_class . " style=\" color:" . $bg_text_color . ";" . $bg_inline_css . "\">" . $bg_expand_text . "</button>";	
		$bg_button_or_link = true;
	}	
	elseif ( $a["view"] == 'button-green') {
		$showmore_btn = "<button id='bg-showmore-action-$bg_uniq_id' class='bg-showmore-plg-button bg-green-button' $bg_onclick " . $bg_btn_icon_class . " style=\" color:" . $bg_text_color . ";" . $bg_inline_css . "\">" . $bg_expand_text . "</button>";
		$bg_button_or_link = true;
	}	
	elseif ( $a["view"] == 'button-red') {
		$showmore_btn = "<button id='bg-showmore-action-$bg_uniq_id' class='bg-showmore-plg-button bg-red-button' $bg_onclick " . $bg_btn_icon_class . " style=\" color:" . $bg_text_color . ";" . $bg_inline_css . "\">" . $bg_expand_text . "</button>";	
		$bg_button_or_link = true;
	}	
